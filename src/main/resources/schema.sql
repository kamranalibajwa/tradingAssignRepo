CREATE TABLE PROPERTIES_COUNTRY_CUTOFF_TIMES (
       ...
       cutoff_time_today ENUM('Never possible','Always possible','9.00','10.00', '11.00', '13.00', '14.00','15.00', '15.30', '16.00') NULL DEFAULT NULL,
       cutoff_time_tomorrow ENUM('Never possible','Always possible','9.00','10.00', '11.00', '13.00', '14.00','15.00', '15.30', '16.00') NULL DEFAULT NULL,
       cutoff_time_after_tomorrow ENUM('Never possible','Always possible','9.00','10.00', '11.00', '13.00', '14.00','15.00', '15.30', '16.00') NULL DEFAULT NULL,
       PRIMARY KEY (id)
);